    ...
    return (
      <footer className="text-white bg-dark">
        <div className="container">
          {/* Links Area */}
          <div className="py-5 md:flex justify-between gap-5 mt-0">
            <div>
              <Link to="/">
              ...
              <p className="mt-5 mb-2">
                43/7 Northern Tower, Banani, Dhaka-1263
              </p>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-10 md:mt-0 mt-10">
              <div>
                <h1 className="font-semibold text-emerald-700 mb-3">
                  Job seekers
                </h1>
                <ul>
                  <li className="mb-2">
                  ...
                  <li className="mb-2">
                    <a href="">Student Career Center</a>
                  </li>
                  <li className="mb-2">
