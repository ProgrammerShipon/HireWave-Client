...
const CandidateList = () => {
    ...
    useEffect(() => {
      let filter = candidatesData.filter(
        (user) =>
        ...
        <section className="m-5 rounded-md">
          ...
          >
            ...
            <div
              ...
              data-tooltip-content="Search candidate name!"
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
              ...
              <select
                ...
                data-tooltip-content="Select candidate status!"
                name="status"
              ...
              <select
                ...
                data-tooltip-content="Select candidate category!"
                name="category"
                className="py-1 border border-gray/40 text-lightGray focus:outline-none focus:border-green rounded-md px-2 w-full sm:w-auto"
                {...register("category")}
              >
