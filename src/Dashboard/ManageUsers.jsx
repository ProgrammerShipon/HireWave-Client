...
const ManageUsers = () => {
  const [userData, loading, refetch] = useUsers();
      ...
      <section className="m-5 rounded-md">
            ...
            <div className="flex items-center justify-between border-b border-[#18025B]/40 mb-2">
              ...
              <div className="text-right pt-1 pb-2">
                <span className="text-[#18025B] text-4xl drop-shadow-xl count__up">
                  <CountUp duration={3} end={recruiterData.length + candidatesData.length + pendingUsers.length} />
                </span>
        ...
        >
          ...
          <div className="w-full sm:w-72"
            data-tooltip-id="search" data-tooltip-content="Search user name!"
          >
            <input
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
            ...
            <Tooltip id="status" />
            <select
              data-tooltip-id="status" data-tooltip-content="Select user status!"
              name="status"
            ...
            <Tooltip id="role" />
            <select
              data-tooltip-id="role" data-tooltip-content="Select user role!"
              name="role"
              className="py-1 border border-gray/40 text-lightGray focus:outline-none focus:border-green rounded-md px-2 w-full sm:w-auto"
              {...register("role")}
            >
