      ...
      <div className="p-3 lg:p-5 rounded-lg hover:shadow-xl hover:shadow-green/20 border border-dark/40 hover:border-green duration-300">
        ...
        <div className="flex flex-col justify-between px-2 mt-5 mb-2">
          ...
          <div>
            ...
            <h3 className="text-xl lg:text-2xl h-14 lg:h-24 text-green font-semibold">
              {" "}
              {title}{" "}
            </h3>
          ...
          <div className="flex justify-between items-center gap-5 mt-3">
            ...
            <Link
              to={`/learning/${_id}`}
              className="bg-purple text-white inline-block px-2 py-1 lg:px-3 lg:py-2 rounded-md duration-300 hover:bg-dark shadow-xl shadow-purple/20 hover:shadow-dark/20 mr-3 cursor-pointer"
            >
              Explore
            </Link>
          </div>
