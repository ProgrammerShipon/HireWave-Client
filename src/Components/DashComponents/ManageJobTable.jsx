    ...
    return (
        <tr className="border-b border-green/20 hover:bg-green/10 duration-300 group">
            ...
            <td className="px-3 py-4">
                <div className={`relative flex gap-1 items-center justify-center px-2 rounded-full text-sm capitalize w-fit mx-auto ${status === 'approve' && 'bg-green/10 text-green font-medium shadow-lg shadow-green/20'} ${status === 'pending' && 'bg-orange-300/10 text-orange-300'} ${status === 'denied' && 'bg-red-500/10 text-red-500'}`}
                >
