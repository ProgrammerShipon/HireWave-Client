...
const Modal = ({ isModalOpen, setIsModalOpen, handleModal, children }) => {
        ...
        <div 
            ...
            <div className="relative p-8 bg-white w-[480px] rounded-lg">
                ...
                <div className='flex items-center mt-3 mr-2'>
                    <div onClick={()=> handleModal("save")} className='text-green text-xl cursor-pointer hover:bg-green/10 rounded-full p-2'><BsCheckCircle /></div>
