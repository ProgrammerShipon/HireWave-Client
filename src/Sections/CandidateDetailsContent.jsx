          ...
          <div className="flex flex-col items-center justify-between gap-4 py-6 duration-300 max-w-48 sm:flex-row lg:flex-col sm:items-end sm:gap-0 sm:-mt-16 lg:-mt-0">
            ...
            <div className="flex flex-col items-center gap-3">
              <button
                ...
                className={`flex items-center justify-center w-full gap-2 px-5 py-3 capitalize duration-300 rounded-lg shadow-xl  group ${
                  !favorite
          ...
          <div className="flex flex-col col-span-2 gap-5 p-6 bg-white shadow-4xl shadow-gray/20">
            ...
            <div>
              ...
              {education.map((edu, index) => (
                <div
                  key={index}
                  className={`border-s pl-6 py-2 ml-3 relative before:absolute before:h-6 before:w-6 before:rounded-full before:top-[10px] before:-left-3 after:absolute after:h-3 after:w-3 after:rounded-full after:top-4 after:-left-[6px] ${
                    edu.endDate === "Present"
                ...
                >
                  <h3
                    className={`text-lg ${
                      edu.endDate === "Present" ? "text-green" : "text-purple"
                    }`}
                  >
                    {edu.subject}
                  </h3>
              ...
              {experience.map((exp, index) => (
                ...
                >
                  <div className="w-16 h-16 overflow-hidden rounded-md shadow-xl shadow-purple/30 flex items-center justify-center">
                    <h1
                      className={`text-3xl uppercase font-semibold drop-shadow-lg ${
                        exp.endDate === "Present" ? "text-green" : "text-purple"
                      }`}
                    >
