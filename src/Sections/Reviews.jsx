    ...
    <section>
      <div className='container'>
        ...
        <div className='mx-auto'>
          ...
          >
            {
              hiringRecommendations.map(recommendation => <SwiperSlide key={recommendation._id} className='h-[280px] md:h-[340px] lg:h-[280px] relative flex flex-col px-5 md:px-8 mb-12 py-6 border-2 border-green rounded-lg'>
