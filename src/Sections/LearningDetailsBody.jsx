          ...
          <div className="lg:grid grid-cols-4 gap-10">
            ...
            <div className="lg:col-span-3">
              ...
              <p className="text-sm mt-3">
                Created: {loadData?.createdAt} | Updated: {updatedAt}
              </p>
              ...
              <div className="flex items-center gap-5 my-10">
                <img
                  ...
                  src={loadData?.authorImg}
                  alt=""
                />
                <div>
                  <h3 className="text-xl text-dark">{loadData?.authorName}</h3>
                  <p className="">{loadData?.authorEmail}</p>
                </div>
              </div>
            ...
            <div className="hidden lg:block col-span-1">
              {loadData?.sidebarContent.map((sidebar) => (
                <div className="p-2 rounded-lg hover:shadow-xl hover:shadow-green/20 border border-dark/40 hover:border-green duration-300 mb-3">
                  ...
                  <img
                    ...
                    src={loadData?.sidebar.thumbnail}
                    alt={loadData?.sidebar.title}
                  />
                  ...
                  <div className="flex flex-col justify-between px-2 mt-5 mb-2">
                    {/* Title & Description */}
                    <div>
                      <div className="text-purple duration-300 hover:underline">
                        {" "}
                        {sidebar.category}{" "}
                      </div>
                    ...
                    <div className="flex items-center gap-3 my-3">
                      <img
                        ...
                        src={loadData?.sidebar.authorImg}
                        alt=""
                      />
                      <h3 className="text-dark">
                        {loadData?.sidebar.authorName}
                      </h3>
                    </div>

                    {/* Detail Button */}
                    <Link
                      to={`/learning/${sidebar._id}`}
                      className="bg-purple text-white inline-block px-2 py-1 lg:px-3 lg:py-2 rounded-md duration-300 hover:bg-dark shadow-xl shadow-purple/20 hover:shadow-dark/20 mr-3 cursor-pointer text-center"
                    >
                      Explore
                    </Link>
                  </div>
