    ...
    <section className="bg-[#edf6f7] py-20 md:py-[120px]">
      <div className="container">
        ...
        <div className="text-center mt-16 md:mt-20">
          <Link to="/allCategoris" className="bg-transparent text-dark hover:text-white px-5 py-2 rounded-lg border border-green hover:bg-green duration-300 shadow-xl hover:shadow-green/20">
            All Category
          </Link>
        </div>
      </div>
