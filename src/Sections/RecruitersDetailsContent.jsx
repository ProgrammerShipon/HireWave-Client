            ...
            <div className="mx-5 md:mx-10 flex flex-col sm:flex-row sm:items-end justify-between gap-4 sm:gap-0 mb-6 mt-4">
              ...
              <div className="flex sm:inline-block sm:flex-col items-center justify-between">
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-5 py-1 text-xl text-white rounded-md sm:mb-3 shadow-lg shadow-green/40 hover:shadow-dark/50 duration-300 w-full ${
                    !follow ? "bg-green hover:bg-dark" : "bg-dark"
                  }`}
                >
                  {!follow ? (
                    <>
